...
export function HeroSection({ backgroundImageSrc }: HeroSectionProps) {
  return (
    <div className="absolute h-[244px] left-0 overflow-clip top-[80px] w-full bg-gradient-to-r from-[#468796] to-[#3c4a78]">
      ...
      <h1 className="absolute font-semibold left-1/2 text-5xl text-white text-center top-[138px] -translate-x-1/2 -translate-y-full whitespace-nowrap">
        About Us
      </h1>
