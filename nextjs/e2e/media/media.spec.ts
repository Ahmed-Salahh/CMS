...
test.describe("Media Page", () => {
  ...
  test.describe("Page Load and Basic Navigation", () => {
    ...
    test("should display filter buttons", async ({ page }) => {
      await expect(
        page.getByRole("button", { name: "All Media" }),
      ).toBeVisible();
  ...
  test.describe("Filter Functionality", () => {
    test("should filter by News", async ({ page }) => {
      ...
      await expect(
        page.locator('nav[aria-label="breadcrumb"]').getByText("News"),
      ).toBeVisible();
    ...
    test("should filter by Events", async ({ page }) => {
      ...
      const eventStatusDropdown = page
        .getByRole("combobox")
        .filter({ hasText: "Event Status" });
    ...
    test("should filter by Gallery", async ({ page }) => {
      ...
      const mediaTypeDropdown = page
        .getByRole("combobox")
        .filter({ hasText: "Media Type" });
  ...
  test.describe("Event Status Filtering", () => {
    ...
    test("should display event status dropdown with options", async ({
      page,
    }) => {
      const eventStatusDropdown = page
        .getByRole("combobox")
      ...
      await expect(
        page.getByRole("option", { name: "Upcoming" }),
      ).toBeVisible();
      await expect(
    ...
    test("should show all events when selecting All status", async ({
      page,
    }) => {
  ...
  test.describe("Gallery Media Type Filtering", () => {
    ...
    test("should display media type dropdown with options", async ({
      page,
    }) => {
      const mediaTypeDropdown = page
        .getByRole("combobox")
    ...
    test("should filter by Video media type", async ({ page }) => {
      ...
      const videoIcons = page
        ...
        .filter({ hasText: "" });
      const itemsExist =
        (await page.locator('[role="main"] a[href^="/media/"]').count()) > 0;
  ...
  test.describe("Pagination", () => {
    ...
    test("should navigate to previous page", async ({ page }) => {
      ...
      // Then click Previous
      const prevButton = page.getByRole("generic", {
  ...
  test.describe("Media Item Cards", () => {
    test("should display media item information", async ({ page }) => {
      const firstItem = page
        .locator('[role="main"] a[href^="/media/"]')
        .first();
    ...
    test("should display event countdown for upcoming events", async ({
      page,
    }) => {
      await page.getByRole("button", { name: "Events" }).click();
